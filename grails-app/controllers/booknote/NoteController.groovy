...
class NoteController {
    ...
    def save(Note noteInstance) {
        ...
        request.withFormat {
            form {
                flash.message = message(code: 'default.created.message', args: [message(code: 'noteInstance.label', default: 'Note'), noteInstance.id])
    ...
    protected void notFound() {
        request.withFormat {
            form {
                flash.message = message(code: 'default.not.found.message', args: [message(code: 'noteInstance.label', default: 'Note'), params.id])
                redirect action: "index", method: "GET"
            }
